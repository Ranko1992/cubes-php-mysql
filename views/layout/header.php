...
<?php require_once __DIR__ . '/../../models/m_news.php'; ?>
                        ...
                        <div class="container">
                            ...
                            <div class="collapse navbar-collapse">
                                <ul class="nav navbar-right" id="main-menu">
                                    ...
                                    <li class="dropdown">
                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">Sekcije vesti</a>
                                        <ul class="dropdown-menu" role="menu">
                                            <?php foreach (sectionsFetchAll() as $sectionsInMenu) { ?>
                                                <li>
                                                    <a href="/news-section.php?id=<?php echo htmlspecialchars($sectionsInMenu['id']); ?>">
                                                        <?php echo htmlspecialchars($sectionsInMenu['title']); ?>
                                                    </a>
                                                </li>
                                            <?php } ?>
                                        </ul>
                                            ...
                                            <?php foreach (categoriesFetchAll() as $categoryInMenu) { ?>
                                                ...
                                                <li>
                                                    <a href="/category.php?id=<?php echo htmlspecialchars($categoryInMenu['id']); ?>">
                                                        <?php echo htmlspecialchars($categoryInMenu['title']); ?>
                                                    </a>
                                                </li>
                                            <?php } ?>
                                  ...
                                  <li class="dropdown">
                                        <a href="#" class="dropdown-toggle" data-toggle="dropdown">Brendovi</a>
                                        <ul class="dropdown-menu" role="menu">
                                            <?php foreach (brandsFetchAll() as $brandsInMenu) { ?>
                                                <li>
                                                    <a href="/brand.php?id=<?php echo htmlspecialchars($brandsInMenu['id']); ?>">
                                                        <?php echo htmlspecialchars($brandsInMenu['title']); ?>
                                                    </a>
                                                </li>
                                            <?php } ?>
                                        </ul>
                                    ...
                                    <?php } else { ?>
                                        <li class="dropdown">
                                            ...
                                            <ul class="dropdown-menu" role="menu">
                                                ...
                                                <li><a href="/crud-tags-list.php">Crud Tags</a></li>
                                                <li><a href="/crud-section-list.php">Crud Sections</a></li>
                                                <li><a href="/crud-news-list.php">Crud News</a></li><li>
